...
var BOMB_APPEARS = 30000; // Каждые 30 секунд появляется бомба
var snake = []; // Сама змейка
var direction = 'y+'; // Направление движения змейки
var gameIsRunning = false; // Запущена ли игра
var snake_timer; // Таймер змейки
var bomb_timer; // Таймер боибы
...
function startGame() {
    ...
    bomb_timer = setInterval(createBomb, BOMB_APPEARS); //каждые 30000мс запускаем функцию createBomb
